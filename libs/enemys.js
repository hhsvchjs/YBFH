...
enemys.prototype.init = function () {
    this.enemys = enemys_fcae963b_31c9_42b4_b48c_bb48d09f3f80; //获取所有怪物信息
    this.enemydata = functions_d6ad677b_427a_4623_b50f_a445a3b0ef8a.enemys; //获取所有怪物方法
...
enemys.prototype.getCurrentEnemys = function (floorId) {
    ...
    for (var b = 0; b < mapBlocks.length; b++) {
        if (core.isset(mapBlocks[b].event) && !mapBlocks[b].disable
			...
			|| mapBlocks[b].event.cls.indexOf('newEnemy') == 0)) {
